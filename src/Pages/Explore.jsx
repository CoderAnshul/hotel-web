                ...
                <div className="w-[85%] flex flex-col items-center max-h-[calc(100vh-3.5rem)] overflow-y-auto">
                  ...
                  <div className="CheckBox w-[100%] mt-3 border-b-2 border-black pb-4 border-opacity-15">
                    ...
                    <FormGroup className="ml-3">
                      {displayedOptions.map((option) => (
                        <FormControlLabel key={option} className="-mb-3" control={<Checkbox checked={selectedOptions.has(option)} onChange={() => handleCheckboxChange(option)} />} label={option} />
                      ))}
                    </FormGroup>
                  ...
                  <div className="CheckBox w-[100%] mt-3">
                    ...
                    <FormControl>
                      ...
                      >
                        <FormControlLabel className="!-mb-3 !ml-1" value="Under ₹ 10,000" control={<Radio />} label="Under ₹ 10,000" />
                        <FormControlLabel className="!-mb-3 !ml-1" value="₹ 10,000 - ₹ 20,000" control={<Radio />} label="₹ 10,000 - ₹ 20,000" />
                        <FormControlLabel className="!-mb-3 !ml-1" value="₹ 20,000 - ₹ 35,000" control={<Radio />} label="₹ 20,000 - ₹ 35,000" />
                        <FormControlLabel className="!-mb-3 !ml-1" value="₹ 35,000 - ₹ 50,000" control={<Radio />} label="₹ 35,000 - ₹ 50,000" />
                        <FormControlLabel className="!-mb-3 !ml-1" value="More than ₹ 50,000" control={<Radio />} label="More than ₹ 50,000" />
                      </RadioGroup>
                    </FormControl>
                  </div>
                    ...
                    <div className=" md:mt-2">
                      <div className="flex md:block justify-between ">
                        ...
                        <div>
                          ...
                          <div className="old-price text-xl mt-2 line-through opacity-65">₹{item.oldprice}</div>
                          <div className="new-price text-3xl mt-1">₹{item.newprice}</div>
                        </div>
                      </div>
                    </div>
