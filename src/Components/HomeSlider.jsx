...
const HomeSlider = () => {
  ...
  return (
    <div className="wrapper relative flex flex-col items-center ">
      ...
      <div className="heading absolute z-50 text-[42px] sm:text-[58px] md:text-[66px] lg:text-[78px] w-[65%] leading-10 sm:leading-[50px] md:leading-[60px] font-fatFace text-white -mt-16 text-center top-1/2 left-1/2 translate-x-[-50%]">More than Just a Stay</div>
      ...
      <div className="search h-20 w-[94%] absolute z-50 -bottom-[90px] lg:hidden">
        <input placeholder="Search For our destination" type="text" className="w-full shadow-xl pl-20 text-xl h-16 rounded-full"/><SearchOutlinedIcon className="absolute scale-125 opacity-75 z-50 left-0 mt-6 ml-8"/>
      </div>
    </div>
  );
};
